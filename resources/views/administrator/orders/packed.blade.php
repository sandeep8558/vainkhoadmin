...
<div class="container-fluid my-4">
    <p class="title-md text-uppercase">Packed Order  ( {{$total}} )</p>
</div>
    ...
    @foreach($orders as $order)
        <div class="row mb-4">
            ...
            <div class="col-12 mb-3">
                ...
                <a onClick="return confirm('Do you really want to send this order to accepted?')" href="/administrator/orders/{{$order->id}}/to_accepted" class="btn btn-sm btn-outline-info">Back to Accepted</a>
            ...
            <!-- <div class="container-fluid my-4 mb-5">
                <a href="/storemanager/orders/{{$order->id}}/to_accepted" class="btn btn-outline-info">Back to Accepted</a>
            ...
            <div class="container-fluid my-4 mb-5">
                <a href="/administrator/orders/{{$order->id}}/shipped" class="btn btn-outline-info">Ship Order</a>
            </div>
