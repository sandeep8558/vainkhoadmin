        ...
        <table class="table table-striped" id="crud-table">
            <thead>
                <tr>
                    ...
                    <th style="width:40px;" class="text-right"><p class="p-0 m-0" style="width:40px;">Action</p></th>
                </tr>
            </thead>
            <tbody>
                ...
                <tr v-for="item in data.data" :key="item.id">
                    ...
                    <td  class="text-right ">
                        <a v-if="formData.model=='ProductGroup'" target="_blank" class="btn shadow-none btn-outline-primary btn-sm" :href="'/webadmin/products/'+item.id"><i class="fas fa-link"></i></a>
                        <a v-if="formData.model=='Product'" target="_blank" class="btn shadow-none btn-outline-primary btn-sm" :href="'/webadmin/products_l/'+item.id"><i class="fas fa-link"></i></a>
                    </td>
